...
const Card = ({ id, type, url, created_at, company,company_logo, company_url, location, title }) => {
    ...
    return (
        <div className="card">
            {company_logo ? <img src={company_logo} className="card__img" /> : <div className="card__img">not found</div>}
